...
import com.example.chigozirikonnekt.adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  void addTabs(){
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_home_icon));
        ...
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_home_fill_icon);
